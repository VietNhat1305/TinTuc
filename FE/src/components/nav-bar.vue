...
<template>
  <header id="page-topbar">
    <div class="navbar-header" style="background: #e9ab2e">
      <div class="d-flex">
        <!-- LOGO -->
        <div class="navbar-brand-box">
          <router-link to="/" class="logo logo-dark">
            <span class="logo-sm">
              <img src="@/assets/images/5.png" alt height="22" />
            </span>
            <span class="logo-lg">
              <img src="@/assets/images/5.png" alt height="17" />
            </span>
          </router-link>
          <router-link to="/" class="logo logo-light">
            <span class="logo-sm">
              <img src="@/assets/images/5.png" alt height="30" />
            </span>
            <span class="logo-lg">
              <img src="@/assets/images/5.png" alt height="55" />
            </span>
          </router-link>
        </div>
        <button
      ...
      <div class="d-flex">
        <div class="dropdown d-none d-lg-inline-block ms-1" style="display: flex; justify-content: center; align-items: center;">
          <button
            type="button"
            class="btn header-item noti-icon pt-2"
        ...
        >
          <template v-slot:button-content>
            ...
            <span class="d-none d-xl-inline-block ms-1">
              ...
              <div v-else>Nguyễn Việt Nhật</div>
            </span>
          </template>
          <!-- <b-dropdown-item>
